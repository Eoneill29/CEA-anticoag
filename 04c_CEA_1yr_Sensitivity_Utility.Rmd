...
##Rivaroxaban Values 
riv.u.ne    <- c(0.75, 0.825, 1.00)  / 12         #Utility of No Event
riv.u.vr    <- c(0.57, 0.76, 0.95)   / 12         #Utility of recurrence  
riv.u.mb    <- c(0.15, 0.61, 0.86)   / 12         #Utility of major bleed
riv.u.nmb   <- c(0.51, 0.65, 0.68)   / 12         #Utility of CRNMB 
riv.u.ot    <- c(0.57, 0.68, 0.83)   / 12         #Utility of off treatment 
##Warfarin Values 
war.u.ne    <- c(0.75, 0.825, 1.00)  / 12         #Utility of No Event
war.u.vr    <- c(0.57, 0.76, 0.95)   / 12         #Utility of recurrence  
war.u.mb    <- c(0.15, 0.61, 0.86)   / 12         #Utility of major bleed
war.u.nmb   <- c(0.51, 0.65, 0.68)   / 12         #Utility of CRNMB 
war.u.ot    <- c(0.57, 0.68, 0.83)   / 12         #Utility of off treatment 
