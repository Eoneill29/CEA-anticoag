...
MC draws for event rates, costs and utilities (5 year)
...
# Save psa object
saveRDS(psa, here::here("output","results_5yr_sens_09_MC_CostsUtility.rds"))
...
```{r}
basecase <- readRDS(here::here("output","results_5yr_basecase.rds"))
